...
class AlienInvasion:
    """A class to manage all game assets and behavior."""
...
# Use the below code for FULLSCREEn        
...
# Start Alien Invasion in an active state
    ...
    def run_game(self):
        """Start the mmain loop for the game."""
        while True:
            self._check_events()
            if self.game_active:
                self.ship.update()
    ...
    def _update_aliens(self):
        ...
        """Check if the fleet is at an edge, thenupdate positions."""
